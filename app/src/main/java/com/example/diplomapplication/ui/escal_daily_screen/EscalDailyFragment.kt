...
class EscalDailyFragment: Fragment() {

    private val viewModel: EscalDailyScreenViewModel by viewModel()
    ...
    override fun onDestroy() {
        super.onDestroy()
        setFragmentResult(TestType.ESCAL_DAILY.label, bundleOf(TEST_FINISHED to viewModel.isFinished.value))
    }
}
