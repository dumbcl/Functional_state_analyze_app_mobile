...
fun GenchScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(stringResource(R.string.gench_test))
                },
                navigationIcon = {
                    Icon(
        ...
        Box(
            ...
            Column(
                ...
                when (uiState.screenState) {
                    GenchScreenState.ScreenState.EXPERIMENT -> {
                    ...
                    GenchScreenState.ScreenState.PRE_EXPERIMENT_CHECK -> {
                        val preExpText = stringResource(R.string.gench_expalanation_pre_exp)
                        genchBlocks(
                    ...
                    GenchScreenState.ScreenState.PRE_EXPERIMENT -> {
...
@Composable
private fun ColumnScope.genchBlocks(
