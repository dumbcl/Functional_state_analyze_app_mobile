...
class TextAuditionFragment: Fragment() {
    ...
    private val viewModel: TextAuditionScreenViewModel by viewModel()
    ...
    override fun onDestroy() {
        super.onDestroy()
        setFragmentResult(TestType.TEXT_AUDITION.label, bundleOf(TEST_FINISHED to viewModel.isFinished.value))
    }
}
